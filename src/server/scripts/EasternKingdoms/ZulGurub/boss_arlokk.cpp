    ...
    public: boss_arlokk() : CreatureScript("boss_arlokk") { }
        ...
        struct boss_arlokkAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                _Reset();
                Initialize();
                me->SetVirtualItem(VIRTUAL_ITEM_SLOT_0, uint32(WEAPON_DAGGER));
                me->SetVirtualItem(VIRTUAL_ITEM_SLOT_1, uint32(WEAPON_DAGGER));
                me->SetWalk(false);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_TRANSFORM:
                        {
                            ...
                            me->SetVirtualItem(VIRTUAL_ITEM_SLOT_0, uint32(EQUIP_UNEQUIP));
                            me->SetVirtualItem(VIRTUAL_ITEM_SLOT_1, uint32(EQUIP_UNEQUIP));
                            /*
